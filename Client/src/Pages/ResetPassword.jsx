...
function ResetPassword() {
  ...
  return (
    <>
      ...
      {!isEmailSent && (
        <form
          className='w-[400px] bg-slate-900 p-10 shadow-lg mt-10 rounded-lg border-gray-200 flex flex-col items-center justify-center m-auto'
        ...
        >
          ...
          <button className='bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full py-2 w-full'>
            Submit
          </button>
        </form>
      )}
